...
ENV SPARK_OPTS="--driver-java-options=-Xms1024M --driver-java-options=-Xmx4096M --driver-java-options=-Dlog4j.logLevel=off" \
...
# Get aws-java-sdk-bundle JAR
RUN wget https://repo1.maven.org/maven2/com/amazonaws/aws-java-sdk-bundle/1.12.226/aws-java-sdk-bundle-1.12.226.jar -P $SPARK_HOME/jars/
